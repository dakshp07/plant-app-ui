...
A Plant UI App Which is made using Dart,Flutter.
...
2) Run The Following Commands :
```git
$ git clone https://github.com/dakshp07/plant-app-ui.git
```

## Images

![First](images/plant.png)

![Second](images/Screenshot_1602686792.png)

![Third](images/Screenshot_1602686759.png)
